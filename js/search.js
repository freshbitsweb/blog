  ...
  function displaySearchResults(results, store) {
    ...
    if (results.length) { // Are there any results?
      ...
      for (var i = 0; i < results.length; i++) {  // Iterate over the results
        ...
        appendString += ' <li><div class="panel panel-default"><div class="panel-heading"><a href="' + item.url + '"><strong>' + item.title + '</strong></a></div><div class="post_details_head"> <div class="post_details"> <span class="glyphicon glyphicon-time"></span> '+item.date+' </div> <div class="post_details"> <span class="glyphicon glyphicon-user"></span> Posted by <span class="dark_text">Admin</span> </div> <div class="post_details"> <span class="glyphicon glyphicon-comment"></span> Comments : <span class="dark_text">22</span> </div> </div> <div class="panel-image"> <img src="/images/'+item.image+'" alt="'+item.alternateText+'"> </div> <div class="panel-body homepage-panel-body"> ' + item.content.substring(0, 300) + '... <div class="readmorebutton orange"> <a href="' + item.url + '" class="btn btn-default"> Read More <span class="glyphicon glyphicon-arrow-right"></span> </a> </div> </div> </div> </li>';
      }
